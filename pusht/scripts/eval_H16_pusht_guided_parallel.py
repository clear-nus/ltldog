"""
Usage:
python eval_H16_pusht_guided_parallel.py --config-name eval_H16_pusht_guided

--diffusion_checkpoint  data/pretrained/diffusion/dp-H16-O2-A8-epoch=0700-test_mean_score=0.911.ckpt

--value_checkpoint  data/pretrained/value/val-H16O2A8-ltls_no_4-epoch=0099-weighted_loss=0.07827.ckpt
...
def main(cfg):
    ...
    tester_dtl = DTL_Cont_Cons_Evaluator(device=cfg.device)
